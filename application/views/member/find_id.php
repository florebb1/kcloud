                ...
                <form id="registForm">
                    <div class="border p-5 mb-5">
                        <div class="form-row mb-3">
                            ...
                            <div class="col-6"><input type="text" name="userName" class="form-control"></div>
                        </div>
                        <div class="form-row mb-3">
                        ...
                        <div class="form-row mb-3">
                            <div class="col-3 text-right"></div>
                            <div class="col-6">
                                <p class="text-secondary">인증번호가 오지 않나요? <a class="text-dark" data-toggle="popover" data-content="발송한 메일이 스팸 메일로 분류된 것은 아닌지  확인해 주세요. 스팸 메일함에도 메일이 없다면, 다시 한 번 '인증번호 받기'를 눌러주세요.">✑</a></p>
...
<script src="/assets/js/page/member/find-id.js"></script>
</body>
</html>