		...
		<div class="container">
			...
			<div class="row mt-5 mb-5">
				...
				<div class="col d-flex justify-content-between">
					<h4>성능 모니터 현황</h4>
                    <select class="custom-select w-25 mb-3" name="gp_id" id="gp_id" onchange="select_graph()">
						<?=$select_graph?>
                    </select>
				...
				<div class="col-12 col-md-6">
					<div class="border min-height120 d-flex flex-column bluegray" id="graph_A">
						<h5 class="p-3">가용성</h5>
                        <h2 class="text-center"><span>Sample data</span> </h2>
					</div>
                    <div class="border min-height120 d-flex flex-column bluegray" id="graph_B">
                        <h5 class="p-3">응답시간</h5>
                        <h2 class="text-center"><span>Sample data</span> </h2>
                    </div>
                    <!--
                    <div class="border min-height120 d-flex flex-column bluegray" id="graph_C">
                        <h5 class="p-3">
                            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="border min-height120 d-flex flex-column bluegray" id="graph_D">
                        <h5 class="p-3">이벤트 알림 지연</h5>
                        <h2 class="text-center"><span>Sample data</span> </h2>
                    </div>
                    <div class="border min-height120 d-flex flex-column bluegray" id="graph_E">
                        <h5 class="p-3">interrupt 발생</h5>
                        <h2 class="text-center"><span>Sample data</span> </h2>
                    </div>
                    <!--
                    <div class="border min-height120 d-flex flex-column bluegray" id="graph_F">
		...
		if(gp_id){
            if(gp_id=="pop"){
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        console.log(response);
                        $("#graph_A").html(response.A);
                        $("#graph_B").html(response.B);
                        $("#graph_C").html(response.C);
                        $("#graph_D").html(response.D);
                        $("#graph_E").html(response.E);
