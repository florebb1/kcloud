        ...
        <div class="main-content">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">PaaS</li>
                </ol>
            </nav>
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <table class="table">
                        ...
                        <thead>
                        <tr>
                            <th scope="col" colspan="4">PaaS 확인 업체</th>
                        </tr>
                        </thead>
...
<script src="/assets/js/admin/confirm/paas.js?ver=<?=time()?>"></script>
</body>
</html>
