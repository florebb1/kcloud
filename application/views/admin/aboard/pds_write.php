        ...
        <div class="main-content">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">자료실 - 글쓰기 / 수정하기</li>
                </ol>
            </nav>
            ...
            <div class="row">
                <form id="noticeForm" class="col-12 mt-4" name="noticeForm" method="post" enctype="multipart/form-data">
...
<script src="/assets/js/admin/aboard/pds_write.js"></script>
</body>
</html>
